...
$datenschutzerklaerung = "https://huntredtimes.github.io/fbz-arbeitskreis5/Seiten/datenschutz.html";  //  Pfad zur Datenschutzerklärung. "datenschutz.php" kann durch einen Link/URL ersetzt werden. (muss mit "http://www." anfangen!)
    
$danke = "https://huntredtimes.github.io/fbz-arbeitskreis5/Seiten/danke.html";  // Pfad zur Danke Seite. "danke.php" kann durch einen Link/URL ersetzt werden. (muss mit "http://www." anfangen!) Die entsprechende Danke Seite kann mit dem nachfolgenden Script auch außerhalb des iFrame angezeigt werden: http://www.kontaktformular.com/faq-script-php-kontakt-formular.html#Danke-Seite-außerhalb-vom-IFrame-anzeigen
...
$cfg['Links'] = 5;  //  Anzahl der maximal erlaubten Links (0 = keine Links erlaubt)
...
$smtp['user'] = 'Noemi Klimpel'; // Der Benutzername, mit welchem Sie sich bei Ihrem SMTP Server authentifizieren. (kann u.U. die oben genannte E-Mail Adresse sein!)
